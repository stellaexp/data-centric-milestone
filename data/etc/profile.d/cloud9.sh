...
export C9_FULLNAME='Kim Shillam'
export C9_HOSTNAME='data-centric-milestone-stellaexp.c9users.io'
export C9_EMAIL='kimshillam@gmail.com'
export C9_USER='stellaexp'
export C9_PROJECT='data-centric-milestone'
export C9_PID='6739206'
export C9_UID='2014787'
